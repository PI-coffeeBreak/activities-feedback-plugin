...
import { useActivities, useUsers } from "coffeebreak/contexts";
...
const ActivitiesFeedback = () => {
  ...
  const fetchFeedback = async (activityId, activityName) => {
    try {
      const response = await api.get(`${baseUrl}/activities-feedback-plugin/feedback_activities/${activityId}/all/`);
